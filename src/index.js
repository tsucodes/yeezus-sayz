...
// const data = [
//   {
//     name:'Kanye West, commonly known as Yeezus, Ye or The Louis Vitton Don',
//     hometown: 'Ye was born in Atlanta, GA and raised in Chicago, IL',
...
root.render(
  <React.StrictMode>
    <Router><App  name={name} hometown={hometown} career={career} accomplishments={accomplishments} networth={networth}/></Router>
  </React.StrictMode>
);
